        ...
        <main className="mt-36 mx-auto max-w-7xl px-4 sm:mt-36">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">Certify, Tokenize, Empower</span>{' '}
              {/* <span className="block text-indigo-600 xl:inline">online business</span> */}
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Empower your achievements with NFT certificates – the future of credentialing. Join us today for secure, globally recognized digital credentials."
            </p>
            ...
            <div className="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
              <div className="lg:self-center">
                <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
                  <span className="block">Use NFTInscribe in your Digital Locker</span>
                </h2>
                <p className="mt-4 text-lg leading-6 text-green-200">
                NFT-based certificate generation and validation systems, powered by blockchain technology, provide a secure, efficient, and accessible solution to the drawbacks of traditional paper-based certificate systems in India. These digital certificates, represented as unique NFTs, offer enhanced security against fraud and tampering, instant and automated verification, easy ownership and transferability, and the potential for monetization and rarity.
                </p>
